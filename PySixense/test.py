...
print(sys.version)
print(sys.path)
sys.path.append("E:\\Forward_Project\\TaurusX_CXdev\\python\\PySixense\\")
import os
os.environ['PATH'] = 'E:\\Forward_Project\\TaurusX_CXdev\\python\\PySixense\\' + os.pathsep + os.environ['PATH']
